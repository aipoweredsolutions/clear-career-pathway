...
export function ATSExecutiveCVTemplate({ data, className, accentColor = 'text-slate-900' }: TemplateProps) {
    ...
    return (
        ...
        >
            {/* ═══ HEADER ═══ */}
            <header className="text-center pt-8 pb-4 px-16">
                {/* Name */}
                <h1 className={cn(
                ...
                {personalInfo?.professionalTitle && (
                    <p className="text-[14px] text-neutral-400 uppercase tracking-[0.4em] font-black mb-6 font-sans">
                        {personalInfo.professionalTitle}
                    </p>
                )}
                    ...
                    <div className="px-16 pb-16">
                        ...
                        {professionalSummary?.summaryText && (
                            <section>
                                ...
                                <p className="text-[15px] text-neutral-700 leading-relaxed text-justify font-serif italic pl-8">
                                    {professionalSummary.summaryText}
                                </p>
                            </section>
                        )}
                            ...
                            <section>
                                ...
                                <div className="space-y-8">
                                    {workExperience.map((job, i) => (
                                        <div key={i} className={cn("pl-8", job.forcePageBreak && "force-page-break")}>
                                            {/* Company + Dates */}
                                    ...
                                    {education.map((edu, i) => (
                                        <div key={i} className={cn(edu.forcePageBreak && "force-page-break")}>
                                            <div className="flex justify-between items-baseline mb-1">
                                                <h3 className="text-[16px] font-black text-neutral-900 uppercase tracking-widest">
                                            ...
                                            <div className={cn('text-[14px] font-bold italic mb-2', accentColor)}>
                                                {edu.institutionName}
                                                {edu.location && (
                                                    <span className="font-normal text-neutral-400 not-italic mx-3">|</span>
                                                )}
                                                {edu.location && (
                                                    <span className="font-normal text-neutral-500 not-italic uppercase tracking-wider text-[11px]">{edu.location}</span>
                                                )}
                                            </div>
                                            {edu.gpa && (
                                                <div className="text-[12px] text-neutral-600 font-serif italic mb-2">
                                                    Academic Record: {edu.gpa}
                                                </div>
                                            )}
                                            {edu.achievements && (
                                                <p className="text-[13px] text-neutral-600 leading-relaxed pl-4 border-l border-neutral-100">
                                                    {edu.achievements}
                                                </p>
                                            )}
                                        </div>
                            ...
                            <section>
                                ...
                                <div className="space-y-2">
                                    {achievements.map((ach, i) => (
                                        <div key={i} className={cn(ach.forcePageBreak && "force-page-break")}>
                                            <div className="flex justify-between items-baseline">
                                                <div className="text-[12px]">
                            ...
                            <section>
                                ...
                                <div className="space-y-3">
                                    {volunteerExperience.map((vol, i) => (
                                        <div key={i} className={cn(vol.forcePageBreak && "force-page-break")}>
                                            <div className="flex justify-between items-baseline">
