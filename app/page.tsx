...
export default function Home() {
    ...
    return (
        <div className="min-h-screen font-sans relative">
            ...
            {/* Pricing Section */}
            <section id="pricing" className="py-32 bg-neutral-950 border-t border-white/10 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary-600/10 rounded-full blur-[150px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-5xl font-black text-white mb-6 tracking-tighter">Simple, Transparent Pricing.</h2>
                        <p className="text-xl text-neutral-400 font-medium">Choose the perfect plan for your career documentation needs. No hidden fees. No subscription traps.</p>
                    </div>
                    <Suspense fallback={<div className="grid md:grid-cols-3 gap-8">{[1, 2, 3].map(i => <div key={i} className="h-96 bg-white/5 border border-white/10 rounded-3xl animate-pulse" />)}</div>}>
                        <div className="[&_.bg-white]:bg-neutral-900 [&_.text-neutral-900]:text-white [&_.text-neutral-700]:text-neutral-300 [&_.text-neutral-600]:text-neutral-400 [&_.border]:border-white/10 [&_.bg-success-50]:bg-emerald-500/20 [&_.text-success-600]:text-emerald-400 [&_.bg-neutral-100]:bg-white/5 [&_.shadow-sm]:shadow-2xl [&_.shadow-sm]:shadow-black/50">
